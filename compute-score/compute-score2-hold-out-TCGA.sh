...
do
	...
	do
		echo "compute-score2-hold-out.py --cohort $cohort --reference_type TCGA --score_type $score_type"
		python3 compute-score2-hold-out.py --cohort $cohort --reference_type TCGA --score_type $score_type
	done	
done
