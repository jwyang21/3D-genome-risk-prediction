...
The overall pipeline for computing stem closeness consists of 3 main steps: (1) inferring 3D genome structure of a single sample, using DNA methylation data only (note that inferred 3D genome state is representated as a vector), (2) computing distances between inferred 3D genome states, and (3) using combinations of distance to quantify stem closeness.          
