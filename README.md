...
- For this case, we need to process raw Hi-C data to get PC1 vectors, since PC1 values are not provided directly.
  ...
  - When processing Hi-C data of other cell line, <ins>name, library\_layout, run\_accession</ins> information of that data should be written in the aforementioned manifest.csv file instead.
