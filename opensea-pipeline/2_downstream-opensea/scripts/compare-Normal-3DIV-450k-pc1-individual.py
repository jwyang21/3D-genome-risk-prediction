...
if __name__=='__main__':
    ...
    #matching_df = pd.read_csv(args.matching_df_fname, index_col = 0)#cancer
    matching_df = pd.read_csv(args.matching_df_fname, index_col = 0).loc[args.cohort].copy()#normal
    ...
    result_dir = f'/data/project/3dith/pipelines/{args.cpg_type}-pipeline/2_downstream-{args.cpg_type}/result/compare-hic-450k-pc1-{args.matrix_type}/normal-individual/3div'
    ...
    #for chrom in CHR_LIST[:1]:#debug
        ...
        #for i in range(1):#debug
            ...
            #cohort_result_dir = os.path.join(result_dir, cohort)#각 cohort 한 번만 돌릴 때
            ...
            #hic_corrmat_fname = os.path.join(args.hic_corrmat_dir, f'{tissue}.hg19_1mb.{chrom}.corrmat.npy')#cancer
            hic_corrmat_fname = os.path.join(args.hic_corrmat_dir, f'{tissue}{str(i+1)}.hg19_1mb.{chrom}.corrmat.npy')#normal
            ...
            for j in range(len(individual_N_pc1_fnames)):
                ...
                individual_N_pc1 = individual_N_pc1_all[chrom_key]
                individual_N_pc1 = standardize(individual_N_pc1)
