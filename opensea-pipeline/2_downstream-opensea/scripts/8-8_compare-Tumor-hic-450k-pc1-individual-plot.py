...
def parse_arguments():
    ...
    args.add_argument('--manifest', help = 'manifest file', type = str, required = False, default = '/data/project/3dith/pipelines/opensea-pipeline/2_downstream-opensea/plots-to-draw-Tumor-individual.csv')
