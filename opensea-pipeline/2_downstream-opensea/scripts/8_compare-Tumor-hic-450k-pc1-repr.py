...
if __name__=='__main__':
    ...
    result_dir = f'/data/project/3dith/pipelines/{args.cpg_type}-pipeline/2_downstream-{args.cpg_type}/result/compare-hic-450k-pc1/tumor-repr'
    ...
    #for chrom in CHR_LIST[:1]:#debug
        ...
        #for i in range(1):#debug
            ...
            current_result_repr.to_csv(os.path.join(cohort_result_dir, f'{chrom}_repr_standardized.csv'), index = False)
