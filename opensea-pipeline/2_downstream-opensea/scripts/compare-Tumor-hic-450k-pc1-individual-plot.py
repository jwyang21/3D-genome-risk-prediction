...
def parse_arguments():
    ...
    args.add_argument('--manifest', help = 'manifest file', type = str, required = False, default = '/data/project/3dith/pipelines/opensea-pipeline/2_downstream-opensea/scripts/bdm/plots-to-draw-Tumor-individual-bdm.csv')
...
if __name__=='__main__':
    ...
    #for chrom in CHR_LIST[:1]:#debug
        ...
        #for i in range(1):#debug
            ...
            cohort_chrom = manifest.loc[cohort]['chrom']
            if chrom == cohort_chrom:
                ...
                for j in range(len(individual_T_pc1_fnames)):
                    ...
                    if current_sample == manifest.loc[cohort]['sample']:
