...
if __name__=='__main__':
    ...
    result_dir = f'/data/project/3dith/pipelines/{args.cpg_type}-pipeline/2_downstream-{args.cpg_type}/result/compare-hic-450k-pc1/normal-repr/3div'
    ...
    #for chrom in CHR_LIST[:1]:#debug
        ...
        #for i in range(1):#debug
            ...
            #cohort_result_dir = os.path.join(result_dir, cohort)#각 cohort 한번만 돌릴때
            ...
            for j in range(len(repr_N_vector_pc1_fnames)):
                ...
                repr_N_pc1 = np.load(current_fname).mean(axis = 0) #column mean
