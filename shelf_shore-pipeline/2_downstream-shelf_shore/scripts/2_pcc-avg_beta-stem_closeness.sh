#command example: bash 2_pcc-avg_beta-stem_closeness.sh > ../log/2_pcc-avg_beta-stem_closeness-ALL.log
...
do
	echo "python3 2_pcc-avg_beta-stem_closeness.py -w_dir $w_dir --cohort $cohort --cpg_type $cpg_type --score_fname $score_f"
	python3 2_pcc-avg_beta-stem_closeness.py -w_dir $w_dir --cohort $cohort --cpg_type $cpg_type --score_fname $score_f
done
