...
do
	...
	do
		echo "python3 beta-pmd-binned-diffmat.py --cohort $cohort --chrom $chrom --binsize 1000000"
		python3 beta-pmd-binned-diffmat.py --cohort $cohort --chrom $chrom --binsize 1000000
	done
done
